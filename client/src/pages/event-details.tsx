...
const events = [
  {
    ...
    gradient: "blue to soft-green",
    highlights: ["Special worship and praise", "Culmination Night"],
  },
  {
    id: 1,
    date: { day: "", month: "" },
...
export default function EventDetails() {
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-8">
            This event is still being planned. Check back later for details!
          </p>
          <Link href="/">
            <Button
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      {/* Header */}
      <div
        className={`bg-gradient-to-br ${event.gradient} py-16 relative overflow-hidden`}
      >
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-xl p-8 sticky top-8">
              <div className="text-center mb-8">
                <div
                  className={`bg-gradient-to-br ${event.gradient} rounded-2xl p-8 mb-6`}
                >
                  <div className="text-white">
